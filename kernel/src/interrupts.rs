...
#[no_mangle]
pub extern "C" fn exception_handler(registers: Registers) {
...
#[no_mangle]
pub extern "C" fn interrupt_handler(registers: Registers) {
...
pub fn init() {
    ...
    // Exceptions
    idt_entry::edit_entry(
        0x00,
        handle_no_err_exception0,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x01,
        handle_no_err_exception1,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x02,
        handle_no_err_exception2,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x03,
        handle_no_err_exception3,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x04,
        handle_no_err_exception4,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x05,
        handle_no_err_exception5,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x06,
        handle_no_err_exception6,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x07,
        handle_no_err_exception7,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x08,
        handle_err_exception8,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x09,
        handle_no_err_exception9,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x0A,
        handle_err_exception10,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x0B,
        handle_err_exception11,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x0C,
        handle_err_exception12,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x0D,
        handle_err_exception13,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x0E,
        handle_err_exception14,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x0F,
        handle_no_err_exception15,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x10,
        handle_no_err_exception16,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x11,
        handle_err_exception17,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x12,
        handle_no_err_exception18,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x13,
        handle_no_err_exception19,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x14,
        handle_no_err_exception20,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x15,
        handle_err_exception21,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x16,
        handle_no_err_exception22,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x17,
        handle_no_err_exception23,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x18,
        handle_no_err_exception24,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x19,
        handle_no_err_exception25,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x1A,
        handle_no_err_exception26,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x1B,
        handle_no_err_exception27,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x1C,
        handle_no_err_exception28,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x1D,
        handle_err_exception29,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x1E,
        handle_err_exception30,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
    idt_entry::edit_entry(
        0x1F,
        handle_no_err_exception31,
        GateType::Trap,
        PrivilegeLevel::Ring3,
    );
